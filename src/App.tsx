...
import { BrowserRouter, Route, Routes, Navigate } from "@/lib/router-compat";
  ...
  return (
    <AppLayout>
      <Suspense fallback={<PageLoader />}><Routes>
        ...
        <Route path="/compras/recebimento/rejeitados" element={<RotaProtegida perm="recebimento"><MateriaisRejeitadosPage /></RotaProtegida>} />
