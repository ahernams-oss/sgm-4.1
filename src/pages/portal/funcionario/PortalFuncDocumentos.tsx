...
export default function PortalFuncDocumentos() {
  ...
  return (
    <PortalLayout requireTipo="funcionario">
      <h1 className="text-xl sm:text-2xl font-semibold mb-4">Meus Documentos</h1>
      <Card className="mb-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            {exames.map((e: any) => (
              <div key={e.id} className="flex flex-wrap items-center justify-between gap-2 border-b pb-2">
                <div>
